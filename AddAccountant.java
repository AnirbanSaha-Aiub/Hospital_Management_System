...
import javax.swing.*;
public class AddAccountant extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Create")){
			if(isEmpty(id) || isEmpty(name) || isEmpty(phn) || isEmpty(password)){
				...
				String sql="insert into accountant values('"+id.getText()+"','"+name.getText()+"','"+phn.getText()+"','"+password.getText()+"')";
				if(da.updateDB(sql)>0){
					JOptionPane.showMessageDialog(this,"Create Accountant Complete!");
				}
