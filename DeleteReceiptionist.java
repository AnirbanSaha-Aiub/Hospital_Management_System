...
import javax.swing.*;
public class DeleteReceiptionist extends Frame implements ActionListener{
	private TextField Id;
	private Button confirmButton,cancelButton;
	private Label l,msg;
	private Frame parent;
	public DeleteReceiptionist(){
		super("Delete Doctor Window");
		l=new Label("ID: ");
		Id=new TextField(10);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Confirm")){
			String sql="delete from receptionist where R_Id='"+Id.getText()+"'";
			m=sql;
